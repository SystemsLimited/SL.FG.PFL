...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MSARecommendationFormUserControl.ascx.cs" Inherits="SL.FG.PFL.WebParts.MSARecommendationForm.MSARecommendationFormUserControl" %>
...
<script type="text/javascript">
    function isActionConfirmed(action) {
        ...
        if (typeof action != 'undefined' && action != null && action != "") {
            if (action == "Save") {
                message = "Do you want to Save MSA Recommendation?";
                flag = true;
            }
            else if (action == "Approve") {
                message = "Do you want to Approve MSA Recommendation?";
                flag = true;
            }
            else if (action == "Reject") {
                message = "Do you want to Reject MSA Recommendation?";
                flag = true;
            }
            else if (action == "Send") {
                message = "Do you want to Send MSA Recommendation?";
                flag = true;
            }
        }
