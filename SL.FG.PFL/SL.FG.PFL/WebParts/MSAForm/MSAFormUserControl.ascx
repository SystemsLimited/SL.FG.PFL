...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MSAFormUserControl.ascx.cs" Inherits="SL.FG.PFL.WebParts.MSAForm.MSAFormUserControl" %>
...
<script type="text/javascript">
    function isActionConfirmed(action) {
        ...
        if (typeof action != 'undefined' && action != null && action != "") {
            if (action == "Save") {
                message = "Do you want to Submit MSA?";
            }
            else if (action == "SaveAsDraft") {
                message = "Do you want to Save MSA as Draft?";
            }
        }
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <div class="col-lg-6">
                                <label>No of Unsafe conditions Identified</label>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <div class="col-lg-6">
                                <label>No of Serious Injury Potential observations</label>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="col-lg-6">
                                <label>No of Fatality Injury Potential observations</label>
                            </div>
                            <div class="col-lg-6">
...
<script src="/_layouts/15/SL.FG.PFL/Scripts/MSA/MSAForm_JSOM.js"></script>

<script src="/_layouts/15/SL.FG.PFL/Scripts/jQuery.js"></script>

<script src="/_layouts/15/SL.FG.PFL/Scripts/MSA/MSAForm.js"></script>
