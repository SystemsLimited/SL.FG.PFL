...
namespace SL.FG.PFL.WebParts.MSAForm
{
    ...
    public partial class MSAFormUserControl : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->Page_Load)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private int GetSubmittedMSAId(SPWeb oSPWeb, int scheduleId)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->GetSubmittedMSAId)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private SPUser UpdateMSAScheduleControls(SPWeb oSPWeb)
        {
            ...
            try
            {
                ...
                if (spListMS != null && !String.IsNullOrEmpty(this.hdnScheduleId.Value))
                {
                    ...
                    if (spListItemMS["PFLScheduleDesignation"] != null)
                    {
                        string designation = Convert.ToString(spListItemMS["PFLScheduleDesignation"]);
                    ...
                    if (spListItemMS["PFLArea"] != null)
                    {
                        string areaAudited = Convert.ToString(spListItemMS["PFLArea"]);
                    ...
                    if (spListItemMS["PFLScheduleName"] != null)
                    {
                        string auditedByUsername = Convert.ToString(spListItemMS["PFLScheduleName"]);
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->UpdateMSAScheduleControls)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private void UpdateControls(bool IsEditCase)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->UpdateControls)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private void FillDropdowns()
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->FillDropdowns)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        {
            SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("41-Page_Load)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, "1", "1");
            bool isMember = false;
            using (SPSite oSPsite = new SPSite(SPContext.Current.Web.Url))
            {
                using (SPWeb oSPWeb = oSPsite.OpenWeb())
            ...
            SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("42-Page_Load)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, "1", "1");
            return isMember;
        }

        private bool CheckPermission_Authenticated_Users()
        {
            SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("51-Page_Load)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, "1", "1");
            bool isMember = false;
            using (SPSite oSPsite = new SPSite(SPContext.Current.Web.Url))
            {
                using (SPWeb oSPWeb = oSPsite.OpenWeb())
            ...
            SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("52-Page_Load)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, "1", "1");
            return isMember;
        }
        ...
        private double CalculateMSAQualityScore(double auditMinutes, int noOfSafetyContacts, string accompaniedBy, int noOfPositivePoint, int noOfAreaImprovement, double noOfFatalityPoints, double noOfUnsafeConditions, double noOfSeriusInjury, int noOfClosureObservations, int noOfConsentTaken)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->CalculateMSAQualityScore)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
            return 0;
        }
        private bool InitializeMSAControls(int msaId)
        {
                        ...
                        if (splistMSA != null)
                        {
                            ...
                            if (spListItemMSA != null)
                            {
                                ...
                                if (isSavedAsDraft == false)
                                {
                                    ...
                                    {
                                        string redirectUrl = "/_layouts/15/ReportServer/RSViewerPage.aspx?rv:RelativeReportUrl=/sites/PFL/Documents/MSADetailReport.rdl&rp:MSAOID=" + this.hdnMSAId.Value.Trim() + "&rv:ParamMode=Hidden";
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->InitializeMSAControls)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private bool FillPositivePointGrid(List<string> lstPositivePoint)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->FillAreaOfImprovementGrid)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
            return false;
        }
        ...
        private bool FillContactGrid(List<MSAContact> lstMSAContact)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->FillContactGrid)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
            return false;
        }
        private bool FillRecommendationGrid(List<MSARecommendation> lstMSARecommendation)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->FillRecommendationGrid)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
            return false;
        }
        private List<MSAContact> GetFormattedContactsByMSA(SPWeb oSPWeb, int msaId)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->GetFormattedContactsByMSA)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private List<MSAContact> GetFormattedContacts(string contacts, String[] pattern1, String[] pattern2)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->GetFormattedContacts)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private PairId GetFormattedIds(string ids, String[] pattern1, String[] pattern2)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->GetFormattedIds)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private List<MSARecommendation> GetFormattedRecommendationsByMSA(SPWeb oSPWeb, int msaId)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->GetFormattedRecommendationsByMSA)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        private List<MSARecommendation> GetFormattedRecommendations(string recommendatons, String[] pattern1, String[] pattern2)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->GetFormattedRecommendations)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        public bool SaveMSADetails(List<MSAContact> contacts, List<MSARecommendation> recommendations, bool isSavedAsDraft, String[] pattern1, String[] pattern2, int? msaId = null)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->SaveMSADetails)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
                                ...
                                string msaQualityScore)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->IsValidMSA)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
                DisableControls();
            }
            return false;
        }
        ...
        private bool IsValidMSAData(SPWeb oSPWeb, List<MSAContact> contactList, List<MSARecommendation> recommendationList)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->IsValidMSAData)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
            }
            return isValid;
        }
        ...
        public bool SaveMSAContacts(SPWeb oSPWeb, List<MSAContact> contacts, int msaId, List<int> contactIds = null)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->SaveMSAContacts)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        public List<Message> SaveMSARecommendations(SPWeb oSPWeb, List<MSARecommendation> recommendations, int msaId, string sentFrom, List<int> recommendationIds = null)
        {
                        ...
                        if (itemToAdd != null)
                        {
                            ...
                            if (!Convert.ToString(itemToAdd["Status"]).Equals("Completed", StringComparison.OrdinalIgnoreCase))
                            {
                                ...
                                if(item.InjuryClass.Equals("Fatality", StringComparison.OrdinalIgnoreCase))
                                {
                                    ...
                                    msgTemp.Subject = message.Subject;
                                    msgTemp.From = message.From;

                                    string tempTo = Utility.GetValueByKey("Email_Notification_Address_Fatality");
                                    string tempSubject = Utility.GetValueByKey("Email_Notification_Address_Fatality_Subject");
                                    string tempBody = Utility.GetValueByKey("Email_Notification_Address_Fatality_Body");

                                    if (!String.IsNullOrEmpty(tempSubject))
                                    {
                                        msgTemp.Subject = tempSubject;
                                    }
                                    if (!String.IsNullOrEmpty(tempBody))
                                    {
                                        msgTemp.Body = tempBody;
                                    }

                                    if (!String.IsNullOrEmpty(tempTo))
                                    {
                                        msgTemp.To = tempTo;
                                        lstMessage.Add(msgTemp);
                                    }
                                }
                            }
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->SaveMSARecommendations)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnSaveAsDraft_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->btnSaveAsDraft_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->btnSave_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->btnCancel_Click)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
