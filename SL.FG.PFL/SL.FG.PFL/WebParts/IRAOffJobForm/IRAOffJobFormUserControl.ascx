...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IRAOffJobFormUserControl.ascx.cs" Inherits="SL.FG.PFL.WebParts.IRAOffJobForm.IRAOffJobFormUserControl" %>
